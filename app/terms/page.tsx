      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 space-y-6 text-gray-700">
          ...
          <section>
            ...
            <p className="mb-4">
              PrepCoach is an AI-powered interview practice platform that provides:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li>Role-specific interview questions and practice sessions</li>
              <li>AI-generated feedback on interview responses</li>
              <li>Audio recording and transcription services</li>
              <li>Resume building and optimization tools</li>
              <li>LinkedIn profile optimization</li>
              <li>Career planning and salary negotiation guidance</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              PrepCoach offers different subscription tiers (Free, Pro, Enterprise, Lifetime):
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li>Subscriptions are billed monthly or as specified</li>
          ...
          <section>
            ...
            <p className="mb-4">
              The Service and its content (text, graphics, logos, software) are owned by PrepCoach and protected by copyright and trademark laws. You retain ownership of content you create (resumes, interview responses), but grant us license to use it to provide the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              PrepCoach shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of the Service. Our total liability shall not exceed the amount you paid for the Service in the past 12 months.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              We reserve the right to suspend or terminate your account at any time for violations of these terms. You may terminate your account at any time by contacting us.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              We may modify these terms at any time. We will notify you of material changes. Continued use of the Service after changes constitutes acceptance of the new terms.
            </p>
          </section>
